  ...
  <body>
    ...
    <!-- main -->
          <div class="row">
            ...
            <form method="POST" action="" class="p-4 bg-light text-left">

           <div class="col-md-6">
              <div class="form-group mt-2  col-md-6">
                  <label for="pseudo">Pseudo *</label>
                  <input type="text" name="pseudo" id="pseudo" placeholder="Votre petit nom" value="<?php echo $_POST['pseudo'] ?? ''; ?>" class="form-control"> 
              </div>
              <div class="form-group mt-2  col-md-6">
                  <label for="mdp">Mot de passe *</label>
                  <input type="password" name="mdp" id="mdp" placeholder="Votre mot de passe" value="" class="form-control">
